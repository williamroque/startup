...
const tips = {
    ...
    'explain-discover': 'Write one of the characters in your dictionary by hand in the canvas below. Then, click the Insert button to save the detected character to one of the white spaces. If the two characters you insert form a valid combo, you will unlock a new character! The haiku is a hint for a new combo.',
